 ...
 *
 * This class represents a judge in a Blackjack game that checks the winner and the actions.
 */

public class BlackjackJudge extends BlackjackGroupJudge<BlackjackPlayer, BlackjackDealer, BlackjackHand> {
    public BlackjackJudge(int dealerValue, int winValue) {
        super(dealerValue, winValue);
    }
    ...
    public boolean canDealerHit(BlackjackDealer dealer) {
        return dealer.getHand().getTotalValue() < getDealerValue();
    }
